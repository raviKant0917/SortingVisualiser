...
def start():
    ...
    if (algorithm_menu.get() == "Selection Sort"):
        selection_sort(data, draw_dataset, dash_scale.get(), sort_canvas)

    if (algorithm_menu.get() == "Quick Sort"):
        quick_sort(data, draw_dataset, dash_scale.get(), sort_canvas)

    if (algorithm_menu.get() == "Insertion Sort"):
        insertion_sort(data, draw_dataset, dash_scale.get(), sort_canvas)

    if (algorithm_menu.get() == "Merge Sort"):
        merge_sort(data, draw_dataset, dash_scale.get(), sort_canvas)
